...
@section('content')
<div class="card-body">
	<form action="{{url('/admin/archivos')}}" method="post" enctype="multipart/form-data">
		@csrf
        ...
        <div class="form-group row {{ $errors->has('archivo') ? ' has-warning' : '' }}">
            <label for="example-text-input" class="col-sm-4 col-form-label" for="archivo">
                Archivo
            </label>
            <div class="col-sm-8">
            	<input class="form-control {{ $errors->has('archivo') ? ' form-control-warning' : '' }}" type="file" id="archivo" name="archivo" value="{{old('archivo')}}" accept=".pdf">
